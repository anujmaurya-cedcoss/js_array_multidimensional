...
<body>
    ...
    echo "Quarter with maximum sales of egg is : <b> $q_egg </b> with total of <b> $max_egg </b> sales <br>";
    ?>
    ...
    echo "Location with minimum consumptioin of milk is : <b> $milk_loc </b> with total of <b> $milk_sales[$milk_loc] </b>l. <br>";
    ?>
    ...
    echo "Location with minimum sales of bread is : <b> $bread_loc </b> with total of <b> $bread_sales[$bread_loc] </b>l. <br>";
    foreach ($data as $quarter => $inQuarter) {
